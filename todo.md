...
## New Feature: เปลี่ยนราคาหุ้นให้เป็นราคาจริง
- [x] หา API สำหรับราคาหุ้นจริง
- [x] อัปเดต StockTicker ให้ใช้ API จริง
- [x] ทดสอบการแสดงผลราคาหุ้นจริง

## New Feature: ข่าวอวกาศจาก NASA
